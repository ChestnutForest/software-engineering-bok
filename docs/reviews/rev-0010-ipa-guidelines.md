...
> **2026-09-19訂正:** 本書は初回検証の履歴である。WARP再確認の現行判断は
> [REV-0011 第3.2節・第8節](rev-0011-ipa-integration-audit.md)を参照する。
> 保存HTMLとIPAの2008年7月版4分冊PDFを取得し、IPAへの譲渡の記載、IPAの著作権表示と使用条件を確認した。
> 第2・3.3節の「登録不可」、第3.3・5節の「WARPは自動取得を許可していない」、
> 第7.2節の当該4分冊に関する権利・出典未確認は、現在の判断として採用しない。
> 現行サイトの不存在・WARPのみという所在の断定、全面的な上位互換も立証されていない。
> 第7.2節の2007年9月・2008年3月という初出月は、今回確認したIPA公開版の日付と区別し、引き続き未確認とする。
> 第8節の決定8は、確認方法と確認結果を分け、手動確認の出典もURL形式等の構造検査は継続するよう訂正する。
> 以下の登録例は未採用の旧案であり、そのまま転用しない。他の修正事項もREV-0011を参照する。
